...
Для работы скетчей требуются следующие библиотеки:
...
Ссылка на архив: [откройте ссылку в новой вкладке](https://github.com/rbcsl/smart_one/raw/main/libraries.zip)
