...
/////////
  ...
  radio.setAutoAck(1);                            //возможно не нужно
  radio.setRetries(0, 15);                        //Указать максимальное количество попыток отправки данных и время ожидания.
  radio.enableAckPayload();                       //Разрешить размещать данные пользователя в пакете подтверждения приёма. возможно не нужно
...
//Участок ниже нужео оптимизировать дополнительно, ввести отдельную функцию для кнопок
